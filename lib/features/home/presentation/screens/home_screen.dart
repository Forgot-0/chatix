  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          // Unread notifications (api-docs §8.3). It lives on the home app
          // bar because that's the one screen every signed-in session passes
          // through — mounting the bell is what starts the unread poll.
